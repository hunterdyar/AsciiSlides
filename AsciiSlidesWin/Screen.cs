...
namespace AsciiSlidesWin
{
    ...
    //monitor code from WpfScreenHelper, released under MIT https://github.com/micdenny/WpfScreenHelper/
    //mostly boilerplate around calls to windows api, which is doing the actual work.
    //This has some features aimed towards an extended desktop, which I don't think I need, but plugging it in is "good enough for now, fix later"
    //where the fix later is getting the displayname for the monitors... i'll probably end up replacing all of this.
